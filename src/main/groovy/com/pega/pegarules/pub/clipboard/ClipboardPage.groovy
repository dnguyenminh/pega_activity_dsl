...
interface ClipboardPage extends StringMap {
     ...
     */
    Object get(Object aPropertyName)
     ...
     */
    Object put(String aPropertyName, Object aValue)
     ...
     */
    void putString(String aPropertyName, String aValue)
     ...
     */
    ClipboardProperty remove(String aReference)
